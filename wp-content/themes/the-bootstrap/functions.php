...
function the_bootstrap_widgets_init() {
	...
	register_sidebar( array(
		'name'			=>	__( 'Homepage Widgets', 'the-bootstrap' ),
		'description'	=>	__( 'Widgets for the homepage.', 'the-bootstrap' ),
		'id'			=>	'homepage-widgets',
	...
	register_sidebar( array(
		'name'			=>	__( 'Footer Widgets', 'the-bootstrap' ),
		'description'	=>	__( 'Widgets for the footer.', 'the-bootstrap' ),
		'id'			=>	'footer-widgets',
		'before_widget' => '<div id="%1$s" class="widget span3 %2$s">',
		'after_widget'  => '</div>',
		'before_title'	=>	'<h3 class="widget-title">',
